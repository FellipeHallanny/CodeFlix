...
public class ListCategoriesTest
{
    ...
    public async Task List()
    {
        ...
        var outputRepositorySearch = new SearchOutput<Entidade.Category>(
            currentPage: input.Page,
            perPage: input.PerPage,
            items: (IReadOnlyList<Entidade.Category>)categoriesExampleList,
    ...
    public async Task ListOkWhenEmpty()
    {
        ...
        var outputRepositorySearch = new SearchOutput<Entidade.Category>(
            currentPage: input.Page,
            perPage: input.PerPage,
            items: (new List<Entidade.Category>()).AsReadOnly(),
            total: 0
        );
